...
navegador.find_element('xpath', '//*[@id="section-17877670"]/section/div[2]/div/form/div[1]/div/div/div/input').send_keys(email_key) #'find_element' - te permite buscar um elemento especifico no site que vc anexou
